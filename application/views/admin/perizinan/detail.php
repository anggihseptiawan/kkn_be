...
<p>File : <a href="<?= base_url() . str_replace(' ', '_', $surat['path']) ?>" download>Download</a> </p>
...
<form method="post" action="<?= base_url("admin/perizinan/submit"); ?>" enctype="multipart/form-data" novalidate class="box">
    ...
    <div class="box__input">
        ...
        <input type="hidden" value="<?= $surat['jenis']; ?>" name="jenis" id="jenis" class="box__file" />
        <input type="hidden" value="<?= $user['user_id']; ?>" name="user_id" />
        <input type="hidden" value="<?= $surat['surat_id']; ?>" name="surat_id" />
        <input type="hidden" value="<?= $surat['keterangan']; ?>" name="keterangan" id="keterangan" class="box__file" />
