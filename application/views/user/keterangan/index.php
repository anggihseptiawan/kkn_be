				...
				<div id="accordion">
					...
					<div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordion">
						<div class="card-body">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
								  <a class="nav-links active" id="pills-rules-tab" data-toggle="pill" href="#pills-rules" role="tab"
									aria-controls="pills-home" aria-selected="true">Persyaratan</a>
								</li>
								<li class="nav-item">
								  <a class="nav-links" id="pills-pelayanan-tab" data-toggle="pill" href="#pills-pelayanan" role="tab"
									aria-controls="pills-profile" aria-selected="false">Mekanisme Pelayanan</a>
								</li>
								<li class="nav-item">
									<a href="#" class="btn btn-success btn-icon-split ml-3">
					...
					<div id="collapseSix" class="collapse " aria-labelledby="headingSix" data-parent="#accordion">
						<div class="card-body">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
								  <a class="nav-links active" id="pills-rules-tab" data-toggle="pill" href="#pills-rules6" role="tab"
									aria-controls="pills-home" aria-selected="true">Persyaratan</a>
								</li>
								<li class="nav-item">
								  <a class="nav-links" id="pills-pelayanan6-tab" data-toggle="pill" href="#pills-pelayanan6" role="tab"
									aria-controls="pills-profile" aria-selected="false">Mekanisme Pelayanan</a>
								</li>
								<li class="nav-item">
									<a href="#" class="btn btn-success btn-icon-split ml-3">
					...
					<div id="collapseTwo" class="collapse " aria-labelledby="headingTwo" data-parent="#accordion">
						<div class="card-body">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
								  <a class="nav-links active" id="pills-rules-tab" data-toggle="pill" href="#pills-rules2" role="tab"
									aria-controls="pills-home" aria-selected="true">Persyaratan</a>
								</li>
								<li class="nav-item">
								  <a class="nav-links" id="pills-pelayanan2-tab" data-toggle="pill" href="#pills-pelayanan2" role="tab"
									aria-controls="pills-profile" aria-selected="false">Mekanisme Pelayanan</a>
								</li>
								<li class="nav-item">
									<a href="#" class="btn btn-success btn-icon-split ml-3">
					...
					<div id="collapseThree" class="collapse " aria-labelledby="headingThree" data-parent="#accordion">
						<div class="card-body">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
								  <a class="nav-links active" id="pills-rules3-tab" data-toggle="pill" href="#pills-rules3" role="tab"
									aria-controls="pills-home" aria-selected="true">Persyaratan</a>
								</li>
								<li class="nav-item">
								  <a class="nav-links" id="pills-pelayanan3-tab" data-toggle="pill" href="#pills-pelayanan3" role="tab"
									aria-controls="pills-profile" aria-selected="false">Mekanisme Pelayanan</a>
								</li>
								<li class="nav-item">
									<a href="#" class="btn btn-success btn-icon-split ml-3">
					...
					<div id="collapseFour" class="collapse " aria-labelledby="headingFour" data-parent="#accordion">
						<div class="card-body">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
								  <a class="nav-links active" id="pills-rules4-tab" data-toggle="pill" href="#pills-rules4" role="tab"
									aria-controls="pills-home" aria-selected="true">Persyaratan</a>
								</li>
								<li class="nav-item">
								  <a class="nav-links" id="pills-pelayanan4-tab" data-toggle="pill" href="#pills-pelayanan4" role="tab"
									aria-controls="pills-profile" aria-selected="false">Mekanisme Pelayanan</a>
								</li>
								<li class="nav-item">
									<a href="#" class="btn btn-success btn-icon-split ml-3">
					...
					<div id="collapseFive" class="collapse " aria-labelledby="headingFour" data-parent="#accordion">
						<div class="card-body">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
								  <a class="nav-links active" id="pills-rules5-tab" data-toggle="pill" href="#pills-rules5" role="tab"
									aria-controls="pills-home" aria-selected="true">Persyaratan</a>
								</li>
								<li class="nav-item">
								  <a class="nav-links" id="pills-pelayanan5-tab" data-toggle="pill" href="#pills-pelayanan5" role="tab"
									aria-controls="pills-profile" aria-selected="false">Mekanisme Pelayanan</a>
								</li>
								<li class="nav-item">
									<a href="#" class="btn btn-success btn-icon-split ml-3">
