<main class="">
    ...
    <div class="row  mt-5 justify-content-center">
            ...
            <div class="card">
                ...
                <h2 class="card-header py-3m-0 font-weight-bold text-primaries ">Ubah Password</h2>
                <div class="card-body ">
 ...
 <div class="row profil-container rounded ">
                    ...
                    <div class="col-lg-12 profil-form ">
                        ...
                        <form class="user" action="<?= base_url("user/changepassword"); ?>" method="post">
                          <?= $this->session->flashdata('message'); ?>
							...
							<div class="form-group">
								<button type="submit" class="btnSubmit w-100">Simpan</button>
							</div>
